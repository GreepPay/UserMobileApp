<template>
  <div class="w-full flex flex-col items-center p-5 space-y-8 h-full">
    <div class="w-full">
      <div
        class="flex items-center space-x-3 py-3 px-4 cursor-pointer rounded-[32px] border-[#0A141E] border-t-[1.5px] border-r-[3px] border-b-0 border-l-[3px]"
      >
        <app-avatar src="images/temps/profile-2.png" alt="name" :size="52" />
